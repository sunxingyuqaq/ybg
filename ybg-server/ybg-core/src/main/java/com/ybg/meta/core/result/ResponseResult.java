package com.ybg.meta.core.result;
...
public class ResponseResult<T> {
     ...
     * @return {@link ResponseResult<T>}
     */
    public static <T> ResponseResult<T> success(String message, T data, String path) {
        ResponseResult<T> response = response(HttpResponseEnum.SUCCESS.getCode(), true, message, data);
