...
import com.ybg.meta.core.constant.LogConst;
...
public class MenuController {
    ...
    @SysLog(logType = LogConst.LOG_TYPE_SAVE)
    ...
    @SysLog(logType = LogConst.LOG_TYPE_UPDATE)
    ...
    @SysLog(logType = LogConst.LOG_TYPE_DELETE)
